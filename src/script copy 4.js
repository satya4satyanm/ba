...
function create() {
  ...
  bow = this.add.image(395, 220, 'atlas', 'Symbol10001').setScale(0.7);
  ...
  this.input.on('pointerdown', function (pointer) {
    bow.destroy();
    bow=null;
    bow = this.add.image(395, 220, 'atlas', 'Symbol10004').setScale(0.7);
...
var Arrow = new Phaser.Class({
  ...
  graphics.strokeRect(this.x, this.y, 5, 5);
